  ...
  def render("invite.json", %{invite: invite}) do
    %{
      ...
      host: if Ecto.assoc_loaded?(invite.host) do
        render_one(invite.host, UserView, "user_short.json") end,
      invitee: if Ecto.assoc_loaded?(invite.invitee) do
        render_one(invite.invitee, UserView, "user_short.json") end,
      team: if Ecto.assoc_loaded?(invite.team) do
        render_one(invite.team, TeamView, "team_short.json") end
    }
  end
end
