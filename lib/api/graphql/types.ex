defmodule Api.GraphQL.Types do
  ...
  #   field :bots, list_of(:ai_competition_bot), resolve: dataloader #assoc(:bots)
  # end
  ...
  #   field :team, :team, resolve: dataloader(Team) #assoc(:team)
  #   field :user, :user, resolve: dataloader(User) #assoc(:user)
  # end
  ...
  #   field :competition, :competition, resolve: dataloader(Competition) # assoc(:competition)
